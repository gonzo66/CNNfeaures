/*
This program gets an image name as a parameter. The best 200 object proposals are obtained, and the CNN are calculated. Layer 5, 6 and predicion layer are saved in disk
*/
#include "kyheader.h"
